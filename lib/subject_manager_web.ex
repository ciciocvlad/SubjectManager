defmodule SubjectManagerWeb do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use SubjectManagerWeb, :controller
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: SubjectManagerWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {SubjectManagerWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: SubjectManagerWeb.Router,
        statics: SubjectManagerWeb.static_paths()
    end
  end
